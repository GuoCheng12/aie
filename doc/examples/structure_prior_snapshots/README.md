...
These snapshots capture the current rule-generated R0 prior objects for three reference molecules under the current main benchmark setup.
...
- Additional ESIPT snapshot: `2N-DPAS`
